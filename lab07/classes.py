...
class AICard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        """
        "*** YOUR CODE HERE ***"
        opponent_card.attack = opponent_card.attack - opponent_card.defense if  opponent_card.attack - opponent_card.defense>0 else 0
...
class TutorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        """
        "*** YOUR CODE HERE ***"
        assert len(player.deck.cards) >3,'Least 3 cards!'
        for i in range(3):
            player.hand.pop(0)
        # player.hand = [player.draw for _ in range(3)]
