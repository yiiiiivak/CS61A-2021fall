...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    center_city = make_city("center",lat,lon)
    if distance(center_city,city_a) < distance(center_city,city_b):
...
def sprout_leaves(t, leaves):
    ...
    return tree(label(t), [sprout_leaves(branch, leaves) for branch in branches(t)]) #输出所有braches上的节点
